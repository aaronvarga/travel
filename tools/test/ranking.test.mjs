...
test('default appeal order keeps all active and reference trips visible', () => {
  ...
  assert.deepEqual(ordered.slice(0, 4).map((trip) => trip.slug), ['portugal', 'slovenia-adriatic', 'madeira-mallorca', 'portugal-sicily']);
  assert.equal(ordered.filter((trip) => !trip.excluded).length, 17);
