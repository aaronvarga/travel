...
test('all comparison and short trips have evidence and canonical variants', () => {
  ...
  assert.deepEqual(shortSlugs.sort(), ['short-algarve', 'short-iceland', 'short-madeira', 'short-portugal']);
